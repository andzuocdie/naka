...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+"[*]"+Fore.WHITE+" Nabika attack => " + str((until - datetime.datetime.now()).total_seconds()) + " sec left ")
        else:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+"[*]"+Fore.WHITE+" Nabika attack done !                                   \n")
            return
#ua
...
#endregion
def get_info_l7():
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.LIGHTGREEN_EX+"URL      "+Fore.LIGHTGREEN_EX+": "+Fore.LIGHTGREEN_EX)
    target = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.LIGHTGREEN_EX+"THREAD   "+Fore.LIGHTGREEN_EX+": "+Fore.LIGHTGREEN_EX)
    thread = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.LIGHTGREEN_EX+"TIME(s)  "+Fore.LIGHTGREEN_EX+": "+Fore.LIGHTGREEN_EX)
    t = input()
    return target, thread, t

def get_info_l4():
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.LIGHTGREEN_EX+"IP       "+Fore.LIGHTGREEN_EX+": "+Fore.LIGHTGREEN_EX)
    target = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.LIGHTGREEN_EX+"PORT     "+FFore.LIGHTGREEN_EX+": "+Fore.LIGHTGREEN_EX)
    port = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.LIGHTGREEN_EX+"THREAD   "+Fore.LIGHTGREEN_EX+": "+Fore.LIGHTGREEN_EX)
    thread = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.LIGHTGREEN_EX+"TIME(s)  "+Fore.LIGHTGREEN_EX+": "+Fore.LIGHTGREEN_EX)
...
##############################################################################################
def title():
    stdout.write(""+Fore.LIGHTBLUE_EX+"    _  _   _   ___ ___ _ "+Fore.LIGHTMAGENTA_EX  +" __   _       ___ ___ \n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"   | \| | /_\ | _ )_ _| |"+Fore.LIGHTMAGENTA_EX  +"/ /  /_\     |_ _|_ _|\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"   | .` |/ _ \| _ \| || '"+Fore.LIGHTMAGENTA_EX  +" <  / _ \     | | | | \n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"   |_|\_/_/ \_\___/___|_|"+Fore.LIGHTMAGENTA_EX  +"\_\/_/ \_\   |___|___|\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"                                                                    \n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ╚═══╦═════════════[ "+Fore.LIGHTGREEN_EX   +"NABIKA"+Fore.LIGHTMAGENTA_EX  +" ]"+Fore.LIGHTMAGENTA_EX  +"═════════════╦═══╝\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ╔═══╩══════════════════"+Fore.LIGHTMAGENTA_EX  +"══════════════════╩═══╗\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ║"+Fore.LIGHTGREEN_EX   +"     Welcome To The Software "+Fore.LIGHTRED_EX  +"Nabika V2  "+Fore.LIGHTMAGENTA_EX  +"    ║\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ║"+Fore.LIGHTGREEN_EX   +"    Copyright : Nabika Hacking Security   "+Fore.LIGHTMAGENTA_EX  +"  ║\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ╚═══╦══════════════════"+Fore.LIGHTMAGENTA_EX  +"══════════════════╦═══╝\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"      ╚═╦════════════════"+Fore.LIGHTMAGENTA_EX  +"════════════════╦═╝ \n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"        ║ - "+Fore.LIGHTGREEN_EX   +"Admin : Bao An & Ngoc Phuc"+Fore.LIGHTMAGENTA_EX  +" - ║     \n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"      ╔═╩════════════════"+Fore.LIGHTMAGENTA_EX  +"════════════════╩═╗ \n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ╔═══╩══════════════════"+Fore.LIGHTMAGENTA_EX  +"══════════════════╩═══╗ \n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ║"+Fore.LIGHTGREEN_EX   +"    Powered By Nabika Hacking Security "+Fore.LIGHTMAGENTA_EX  +"     ║\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ║"+Fore.LIGHTGREEN_EX   +"     Thank You For Using My Software "+Fore.LIGHTMAGENTA_EX  +"       ║\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ║"+Fore.LIGHTGREEN_EX   +" Please Write "+Fore.LIGHTRED_EX   +"NABIKA"+Fore.LIGHTGREEN_EX   +" To Enter The Software "+Fore.LIGHTMAGENTA_EX  +" ║\n")
    stdout.write(""+Fore.LIGHTBLUE_EX+"  ╚══════════════════════"+Fore.LIGHTMAGENTA_EX  +"══════════════════════╝ \n")
    stdout.write("\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTGREEN_EX+"["+Fore.LIGHTGREEN_EX  +""+Fore.LIGHTRED_EX+"@NABIKA"+Fore.LIGHTWHITE_EX+""+Fore.LIGHTGREEN_EX+""+Fore.LIGHTGREEN_EX+"]"+Fore.LIGHTGREEN_EX+" > "+Fore.LIGHTGREEN_EX+"")
    command = input()
...
##############################################################################################     
        ...
        stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE+"IP "+Fore.LIGHTCYAN_EX+": "+Fore.LIGHTCYAN_EX)
        target = input()
        try:
        ...
        stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE+"IP/DOMAIN "+Fore.LIGHTCYAN_EX+": "+Fore.LIGHTCYAN_EX)
        target = input()
        try:
